...
if __name__ == '__main__':
    ...
    #  加载模型
    #h5_model = load_model('resnet50_full.h5')
    h5_model = models.load_model('resnet50_full.h5', backbone_name="resnet50")
    h5_to_pb(h5_model, output_dir=os.getcwd(), model_name=output_graph_name)
    print('Finished')